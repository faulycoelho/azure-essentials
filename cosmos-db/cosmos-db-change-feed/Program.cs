...
var builder = sourceContainer.GetChangeFeedProcessorBuilder<Product>
    (processorName: "productsProcessor", onChangesDelegate: handleChanges);
ChangeFeedProcessor processor = builder
    .WithInstanceName("consoleApp-one")
...
//after that, run console: dotnet run 

//new terminal: dotnet tool install cosmicworks --global --version 1.*
//insert/update items: cosmicworks --endpoint <cosmos-endpoint> --key <cosmos-key> --datasets product
